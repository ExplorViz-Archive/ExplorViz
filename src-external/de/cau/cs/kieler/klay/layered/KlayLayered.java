...
public final class KlayLayered {
	...
	final String debugFileName = Util.getDebugOutputFileBaseName(graph) + "fulldebug-slot"
		+ slotIndex;
    ...
    private static final IntermediateProcessingConfiguration BASELINE_PROCESSING_CONFIGURATION	= new IntermediateProcessingConfiguration(
													      ...
													      // 4
													      EnumSet.of(
														      LayoutProcessorStrategy.NODE_MARGIN_CALCULATOR,
    ...
    private static final IntermediateProcessingConfiguration FLATTENED_HIERARCHY_PROCESSING_ADDITIONS = new IntermediateProcessingConfiguration(
													      ...
													      // 4
													      EnumSet.of(
														      LayoutProcessorStrategy.SUBGRAPH_ORDERING_PROCESSOR,
