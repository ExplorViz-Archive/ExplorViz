...
/**
 * This class is representing a rectangle and provides some comfort methods to
 * work with the rectangle. Special about this implementation is that there is
 * no width and height is stored. This improves the performance of unions and
 * accesses to the right/top side.
 *
 * @author tit
 */
public final class Rectangle {
	...
	/**
	 * Creates a new Rectangle for the given KVector, resulting in a rectangle
	 * with height = width = 0.
	 * 
	 * @param position
	 ...
	 * 
	 * @param shape
	 *            The shape to form the rectangle around.
	 */
	 ...
	 * 
	 * @param vectors
	 *            The coordinates to span the rectangle around.
	 */
	 ...
	 * 
	 * @param vectors
	 *            The vectors to span a rectangle around.
	 */
	 ...
	 * 
	 * @param vector
	 *            The vector to the coordinate to include.
	 */
	 ...
	 * 
	 * @param enlargement
	 *            The value this rectangle will be enlarged in all four
	 *            directions.
	 */
	...
	/**
	 * Returns the coordinate of the edge of this rectangle that is
	 * corresponding to the given {@link PortSide}.
	 * 
	 * @param side
	 *            The {@link PortSide} for which to return the edge of this
	 *            rectangle.
	...
	/**
	 * Creates a margin that is relative to a {@link LShape}, so that this
	 * {@link Rectangle} completely lays inside the margins and is of minimal
	 * size. The margins of any side of the shape will be at least 0. If the
	 * given shape is a {@link LNode} it's margin is neither modified nor taken
	 * into account.
	 * 
	 * @param shape
	 *            The shape the margins shall lay around.
