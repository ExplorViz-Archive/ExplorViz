...
public class MapPropertyHolder implements IPropertyHolder, Serializable {
    ...
    /**
     * Retrieves a property value for a given class. If the property holder contains multiple
     * instances of the class, the returned instance is selected arbitrarily. This method is less
     * efficient than {@link #getProperty(IProperty)}, so use it with caution.
     * 
     * @param <T>
     *            type of property
     * @param clazz
    ...
    // if (propertyMap != null) {
    // // for (final Object value : propertyMap.values()) {
    ...
    /**
     * Check for upper and lower bounds. If a property value does not fit into the bounds, it is
