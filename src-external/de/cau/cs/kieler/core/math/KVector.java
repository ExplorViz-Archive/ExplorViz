...
public class KVector implements IDataObject, Cloneable {
    ...
    /**
     * Returns angle representation of this vector in degree. The length of the vector must not be
     * 0.
     * 
    ...
    /**
     * Returns angle representation of this vector in radians. The length of the vector must not be
     * 0.
     * 
