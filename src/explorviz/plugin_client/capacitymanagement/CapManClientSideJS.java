				...
				.dialog(
						{
							...
							buttons : {
								"OK" : function() {
									@explorviz.plugin_client.capacitymanagement.CapManClientSide::conductOkAction()()
									$wnd.jQuery(this).dialog("close");
								},
								"Refine manually" : function() {
									@explorviz.plugin_client.capacitymanagement.CapManClientSide::conductManualRefinementAction()()
									$wnd.jQuery(this).dialog("close");
								},
								"Cancel" : function() {
									@explorviz.plugin_client.capacitymanagement.CapManClientSide::conductCancelAction()()
									$wnd.jQuery(this).dialog("close");
								}
							}
						}).focus();
