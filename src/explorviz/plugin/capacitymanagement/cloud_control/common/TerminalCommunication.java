...
public class TerminalCommunication {
    ...
    private static final Logger LOG = LoggerFactory
            .getLogger(TerminalCommunication.class);
    ...
    public static List<String> executeCommand(final String command)
        ...
        try {
            ...
            if (exitCode != 0) {
                String error = "Command didn't exit cleanly! Command exited with code: "
                        + exitCode + "\n Command was: " + command + "\n";
                while (err.ready()) {
                    error += err.readLine() + "\n";
                }
    ...
    private static void closeOpenIO(final BufferedReader in,
