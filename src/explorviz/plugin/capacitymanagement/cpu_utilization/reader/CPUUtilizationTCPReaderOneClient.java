...
public class CPUUtilizationTCPReaderOneClient extends Thread {
    ...
    private final void readInTraceMetadata(final ByteBuffer buffer) {
        ...
        if (system != null && ip != null && hostname != null
                && application != null) {
            hostApplicationMetadata = new HostApplicationMetaDataRecord(system,
                    ip, hostname, application);
        } else {
    ...
    private final void readInSystemMonitoringRecord(final ByteBuffer buffer) {
        ...
        putInRingBuffer(new SystemMonitoringRecord(cpuUtil, usedRAM,
                absoluteRAM, hostApplicationMetadata));
    }
