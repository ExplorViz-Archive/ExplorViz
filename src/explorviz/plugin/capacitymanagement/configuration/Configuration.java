...
public class Configuration {
    ...
    public Configuration(final String filename) throws IOException {
        ...
        scalingLowCpuThreshold = Double.parseDouble(settings
                .getProperty("scalingLowCpuThreshold"));
        ...
        averageCpuUtilizationTimeWindowInMillisecond = Integer
                .parseInt(settings
                        .getProperty("averageCpuUtilizationTimeWindowInMillisecond"));

        shutdownDelayInMillis = Integer.parseInt(settings
                .getProperty("shutdownDelayInMillis"));
        waitTimeBeforeNewBootInMillis = Integer.parseInt(settings
                .getProperty("waitTimeBeforeNewBootInMillis"));

        cloudNodeLimit = Integer.parseInt(settings
                .getProperty("cloudNodeLimit"));
        ...
        startSystemMonitoringScript = settings
                .getProperty("startSystemMonitoringScript");
    }
