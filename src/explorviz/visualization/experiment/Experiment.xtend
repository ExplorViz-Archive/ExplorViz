...
class Experiment {
	...
	def static List<PrimitiveObject> drawArrow(float x, float y, float z, List<PrimitiveObject> polygons){
		var arrowhead = new Triangle(null, RED, false, true, new Vector3f(x,y,z), new Vector3f(x+0.5f,y+0.5f,z), new Vector3f(x-0.5f,y+0.5f,z), 1f, 0f, 0f, 1f, 1f, 1f)
	...
	def static List<PrimitiveObject> draw3DArrow(float x, float y, float z, List<PrimitiveObject> polygons){
		var arrowhead = new Triangle(null, RED, false, true, new Vector3f(x,y,z+3f), new Vector3f(x+3f,y+3f,z+3f),new Vector3f(x-3f,y+3f,z+3f), 1f, 0f, 0f, 1f, 1f, 1f)
