...
class Line extends PrimitiveObject {
    ...
    var Vector3f firstPoint
    var Vector3f secondPoint
    ...
    def createJointPoint(Vector3f jointPoint, Vector3f lastV, Vector3f newV) {
    ...
    def addTriangle(Vector3f leftPoint, Vector3f rightPoint, Vector3f intersectionPoint) {
    ...
    def createQuad(Vector3f lineWidthVector, Vector3f v, Vector3f startPoint) {
