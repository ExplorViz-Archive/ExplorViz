...
public class Matrix33f {
	...
	public Matrix33f(final Matrix33f m) {
	...
	public Matrix33f(final float _00, final float _01, final float _02, final float _10,
			final float _11, final float _12, final float _20, final float _21, final float _22) {
		entries[0] = _00;
		entries[1] = _01;
		entries[2] = _02;
		entries[3] = _10;
	...
	public Matrix33f mult(final Matrix33f m) {
	...
	public static Matrix33f rotationX(final double angleInDeg) {
	...
	public static Matrix33f rotationY(final double angleInDeg) {
		final double angleInRad = Math.toRadians(angleInDeg);
		final float sin = (float) Math.sin(angleInRad);
		final float cos = (float) Math.cos(angleInRad);
	...
	public static Matrix33f rotationZ(final double angleInDeg) {
		final double angleInRad = Math.toRadians(angleInDeg);
		final float sin = (float) Math.sin(angleInRad);
		final float cos = (float) Math.cos(angleInRad);
	...
	public static Matrix33f rotationAxis(Vector3f axis, final double angleInDeg) {
		axis = axis.normalize();
		final double angleInRad = Math.toRadians(angleInDeg);
		final float sin = (float) Math.sin(angleInRad);
		final float cos = (float) Math.cos(angleInRad);
