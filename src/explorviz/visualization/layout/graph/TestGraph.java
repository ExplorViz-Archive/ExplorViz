...
public class TestGraph {
	public static void main(final String[] args) {
		...
		// Edge array
		final Integer[][] edges = { { 0, 1 }, { 0, 3 }, { 0, 5 }, { 1, 0 }, { 1, 2 }, { 1, 3 },
		...
		/* Test case 1 */
		final HyperGraph<String, Integer> graph1 = new HyperGraph<>(edges, vertices);
		/* Test case 2 */
		// final HyperGraph<String, Integer> graph1 = new HyperGraph<>();
		...
		System.out.println("The vertex with index 0 is " + graph1.getVertex(0));
