 ...
 * rooted tree. (That is, there is a designated single vertex--the
 * <i>root</i>--from which we measure the shortest path to each vertex, which we
 * call its <i>depth</i>; the maximum over all such depths is the tree's
 * <i>height</i>. Note that for a tree, there is exactly one unique path from
