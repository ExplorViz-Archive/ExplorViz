...
class LandscapeDummyCreator {
	...
	def private static createNeo4JDummyApplication(Application application) {
		...
		val toolingClazz = createClazz("AccountSqlMapDa25o", tooling, 5)
		...
		val apiClazz = createClazz("1cleanupX", api, 25)
		createClazz("cleanupX9", api, 25)
		val configuration = createComponent("configuration", kernel, application)
		val configurationClazz = createClazz("cleanupX4", configuration, 35)
		createClazz("cleanupX8", configuration, 5)
		val myextension = createComponent("extension", kernel, application)
		createClazz("cleanupX5", myextension, 25)
		createClazz("cleanupX6", myextension, 5)
		val guard = createComponent("guard", kernel, application)
		val guardClazz = createClazz("cleanupX3", guard, 35)
		createClazz("cleanupX7", guard, 25)
		...
		createClazz("cleanupX125", annotations, 35)
		val apiImpl = createComponent("api", impl, application)
		val apiImplClazz = createClazz("cleanupX2", apiImpl, 25)
		val cache = createComponent("cache", impl, application)
		createClazz("cleanupX23", cache, 45)
		val persistence = createComponent("persistence", impl, application)
		createClazz("AccountSqlMapDao3", persistence, 45)

		val info = createComponent("info", kernel, application)
		createClazz("AccountSqlMapDao4", info, 5)
		createClazz("AccountSqlMapDao5", info, 25)
		val lifecycle = createComponent("lifecycle", kernel, application)
		val lifecycleClazz = createClazz("9AccountSqlMapDao", lifecycle, 25)
		createClazz("AccountSqlMapDao6", lifecycle, 15)

		val logging = createComponent("logging", kernel, application)
		val loggingClazz = createClazz("AccountSqlMapDao8", logging, 25)
