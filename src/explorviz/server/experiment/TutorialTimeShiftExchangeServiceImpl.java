...
public class TutorialTimeShiftExchangeServiceImpl extends RemoteServiceServlet implements
	...
	protected Map<Long, Long> createTimeshiftGraph() {
		...
		// new landscape every 20 seconds
		...
		// if (!Configuration.secondLandscape || (time <
		// Configuration.secondLandscapeTime)) {
		// result.put(Configuration.tutorialStart + (i * 20 * 1000), (long)
		// 5400);
		// } else {
		// result.put(Configuration.tutorialStart + (i * 20 * 1000), (long)
		// 6000);
