...
cd %OFBIZ_HOME%
echo on
"%JAVA_HOME%\bin\java" -Xms128M -Xmx2048M -XX:MaxPermSize=512m -javaagent:framework/base/lib/aspectjweaver.jar -Dorg.aspectj.weaver.loadtime.configuration=aop.xml -jar ofbiz.jar
echo off
