...
import explorviz.plugin.capacitymanagement.scaling_strategies.ScalingManager;
...
public class ScalingManagerTest {
	...
	public void testNewCPUUtilizationAverage() throws Exception {
		final Configuration configuration = new Configuration(TestConstants.CONFIG_FILE);
