...
public class MathHelpersTest {
	...
	@Test
		public void testGetCategoriesForMapping() throws Exception {
			...
			Map<Integer, Integer> categories = MathHelpers.getCategoriesForMapping(arrayList);
			...
			categories = MathHelpers.getCategoriesForMapping(arrayList);
