...
public class MaximumAlgorithmTest {
	...
	// * This information is directly derived from Anomaly Scores. This is done
	// as
	// * follows: We get from every method in this class the latest anomaly
	// score.
	...
	// * @param op
	// * given operation
	// * @return Pair of (Timestamp, Anomaly Score), null if no scores are
	// present
	// */
	// private Entry<Long, Double> getLatestAnomalyScorePair(CommunicationClazz
	// op) {
	...
	// return null;
	// }
	// final List<Entry<Long, Double>> mapEntries = new ArrayList<Entry<Long,
	// Double>>(
	...
	//
	// /**
	// * Returns a list of all available timestamp-anomalyScore pairs for a
	// given
	...
	// // (AnomalyScoreRecord)
	// final TreeMapLongDoubleIValue anomalyScores = (TreeMapLongDoubleIValue)
	// op
	// .getGenericData(IPluginKeys.TIMESTAMP_TO_ANOMALY_SCORE);
	// final List<Entry<Long, Double>> mapEntries = new ArrayList<Entry<Long,
	// Double>>(
	// anomalyScores.entrySet());
	// final List<AnomalyScoreRecord> outputScores = new
	// ArrayList<AnomalyScoreRecord>();
	//
	// for (Entry<Long, Double> entry : mapEntries) {
