...
public class AdvancedMeshAlgorithmTest {
	...
	public void setUpLandscape() {
		rcLandscape = new RanCorrLandscape(
				RCDTestLandscapeBuilder.getAdvancedMeshAlgorithmLandscape());
	}
	 ...
	 */
	@Test
	public void advancedMeshAlgorithmTest() {
		// correct landscape?
		...
		// 1 Thread
		AbstractRanCorrAlgorithm alg = new AdvancedMeshAlgorithm();
